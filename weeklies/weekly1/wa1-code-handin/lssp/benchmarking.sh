...
[[ ! -f test_data/lssp-zeros-data-small-interval-very-large.in ]] && futhark dataset --i32-bounds=-1:1 -b -g '[6400000000]i32' > test_data/lssp-zeros-data-small-interval-very-large.in
[[ ! -f test_data/lssp-zeros-data-large-interval-very-large.in ]] && futhark dataset --i32-bounds=-2040:2040 -b -g '[6400000000]i32' > test_data/lssp-zeros-data-large-interval-very-large.in
...
[[ ! -f test_data/lssp-sorted-data-small-interval-very-large.in ]] && futhark dataset --i32-bounds=1:10 -b -g '[6400000000]i32' > test_data/lssp-sorted-data-small-interval-very-large.in
[[ ! -f test_data/lssp-sorted-data-large-interval-very-large.in ]] && futhark dataset --i32-bounds=-2040:2040 -b -g '[6400000000]i32' > test_data/lssp-sorted-data-large-interval-very-large.in
